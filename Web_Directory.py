...
def check(url, timeout):
    try:
        ...
        if code == 200:
            ...
            website_code_200 = "["+str(code)+"]   "+"Checking : " + url
            #print(website_code_200)
            webdirb_list.append(website_code_200)
            if "404" in response.text:
                #ColorPrinter.print_blue_text()
                website_code_404 = url + "\tMaybe every page same!"
                #print(website_code_404)
                webdirb_list.append(website_code_404)
            ...
            website_code_none = "["+str(code)+"]   "+"Checking : " + url
            #print(website_code_none)
            webdirb_list.append(website_code_none)
            #print("Checking : " + url)
...
def scan_web_dirb(website,threadNumber):
    #if len(sys.argv) != 4:
     #   help(sys.argv[0])
     #   exit(1)
    ...
    #scan_web_dirb('https://www.52sec.me/',2)
